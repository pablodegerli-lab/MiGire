unit URepoMailAEmpresaXArchivoSurD;
...
type
    TRepoMailAEmpresaXArchivoSurD = class(TRepoGemaBaseEmpresa)
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
...
{ TRepoMailAEmpresaXArchivoSurD }

procedure TRepoMailAEmpresaXArchivoSurD.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
procedure TRepoMailAEmpresaXArchivoSurD.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRepoMailAEmpresaXArchivoSurD.BandaDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
	if FRegistroDistribucion.Cod_Cia = 3 then
