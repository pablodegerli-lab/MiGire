...
type
  TRepoMailAEmpresa = class(TRepoGemaBaseEmpresa)
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
...
procedure TRepoMailAEmpresa.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
procedure TRepoMailAEmpresa.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRepoMailAEmpresa.BandaDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
	if FRegistroDistribucion.Cod_Cia = 3 then
