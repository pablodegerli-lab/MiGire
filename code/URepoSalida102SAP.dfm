inherited RepoSalida102SAP: TRepoSalida102SAP
  Functions.DATA = (
    '0'
    '0'
    #39#39)
  ...
  inherited BandaDetalle: TQRBand
    ...
    object QRDBTCantidad: TQRDBText
      Left = 159
      Top = 3
      Width = 86
      Height = 17
    ...
    object QRLNOMBRE_ARCHIVO: TQRLabel
      Left = 4
      Top = 3
      Width = 149
      Height = 17
  ...
  inherited QryBase: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9'    A.COD_CIA = B.COD_CIA and'
      #9'    A.NRO_PROCESO = B.NRO_PROCESO and'
      #9'    A.COD_TIPO_ARCHIVO = B.COD_TIPO_ARCHIVO and'
      #9'    A.COD_DISENO = B.COD_DISENO and'
      #9'    A.NRO_ORDEN = B.NRO_ORDEN and'
      '    '#9'B.INFORME_MAIL = 1 and'
      '      @01 '
      'order by A.COD_TIPO_ARCHIVO,A.NOMBRE_ARCHIVO')
    object QryBaseNOMBRE_ARCHIVO: TStringField
      FieldName = 'NOMBRE_ARCHIVO'
      Size = 30
    end
    object QryBaseCANTIDAD_REGISTROS: TIntegerField
      FieldName = 'CANTIDAD_REGISTROS'
    end
    object QryBaseCANTIDAD_MOVIMIENTOS: TIntegerField
      FieldName = 'CANTIDAD_MOVIMIENTOS'
    end
    object QryBaseCANTIDAD_LOTES: TIntegerField
      FieldName = 'CANTIDAD_LOTES'
    end
    ...
    object QryBaseDESCRIPCION_MAIL: TStringField
