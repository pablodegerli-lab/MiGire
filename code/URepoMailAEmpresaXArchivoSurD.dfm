inherited RepoMailAEmpresaXArchivoSurD: TRepoMailAEmpresaXArchivoSurD
  Functions.DATA = (
    '0'
    '0'
    #39#39)
  ...
  inherited QryBase: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       NVL(A.CANTIDAD_MOVIMIENTOS,0) as CANTIDAD_MOVIMIENTOS,'
      '       A.CANTIDAD_LOTES,'
      '       A.IMPORTE,'
      '       B.DESCRIPCION_MAIL'
      ...
      '      A.COD_CIA = 8 and B.NOMBRE_ARCHIVO LIKE '#39'SURD______.2451'#39' '
