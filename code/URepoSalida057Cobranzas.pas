...
type
  TRepoSalida057Cobranzas = class(TRepoGemaBaseEmpresa)
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
...
procedure TRepoSalida057Cobranzas.Asignar_ParTotales;
begin
  QryTotales.Parameters.ParamByName('pFh_Proceso').Value := FRegistroDistribucion.FMaxFh_Proceso_Actual;

end;

procedure TRepoSalida057Cobranzas.BandaEncabezadoBeforePrint(
...
procedure TRepoSalida057Cobranzas.Ver_Ejecuta_Totales;
begin
  EjecutaTotales := True;

end;

procedure TRepoSalida057Cobranzas.QRDBText5Print(sender: TObject;
  var Value: String);
var sAux:string;
begin
//  inherited;
...
procedure TRepoSalida057Cobranzas.FH_VENTAPrint(sender: TObject;
  var Value: String);
var sAux:string;
begin
//  inherited;
...
procedure TRepoSalida057Cobranzas.QRDBText3Print(sender: TObject;
  var Value: String);
begin
  inherited;
  value := ''''+value;
...
constructor TRepoSalida057Cobranzas.create(AOwner: TComponent;
