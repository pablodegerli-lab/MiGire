...
begin
  ...
  begin
    msgReporte.Text:='Preparando el reporte, espere por favor...';
    msgReporte.MuestraAVI := False;
    msgReporte.Mostrarse(true);
    FReporte.Prepare;
    msgReporte.Mostrarse(false);
    FReporte.Print;
  end
    else
...
begin
  ...
  begin
      msgReporte.Text:='Preparando la vista preliminar, espere por favor...';
      msgReporte.MuestraAVI := False;
      msgReporte.Mostrarse(true);
      Reporte.Prepare;
      msgReporte.Mostrarse(false);
