unit URepoMailAEmpresaXArchivoSurT;
...
type
    TRepoMailAEmpresaXArchivoSurT = class(TRepoGemaBaseEmpresa)
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
...
{ TRepoMailAEmpresaXArchivoSurT }

procedure TRepoMailAEmpresaXArchivoSurT.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
procedure TRepoMailAEmpresaXArchivoSurT.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRepoMailAEmpresaXArchivoSurT.BandaDetalleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
	if FRegistroDistribucion.Cod_Cia = 3 then
